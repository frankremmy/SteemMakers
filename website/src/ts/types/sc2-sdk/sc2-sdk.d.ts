// Based on https://github.com/jayserdny/steemConnect-v2-ts/blob/master/types/sc2-sdk/index.d.ts
// by Jayser Mendez: https://github.com/jayserdny
...
interface IntializationOptions
{
	app: string;
	callbackURL: string;
	accessToken?: string;
...
declare class SC2
{
	Initialize(intializationOptions: IntializationOptions): SC2;
	...
	me(callback: (error: any, result: any)=>void): void;
	...
	// accessToken: Access token of the url attempting to log in
