				...
				<form action="https://v2.steemconnect.com/sign/delegateVestingShares" id="person">
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" placeholder="Your steem ID" name="delegator">
						</div>
					</div>
					<div class="form-group">
						<label class="control-label">Steem Power to delegate</label>
						<div class="input-group">
							<input type="text" class="form-control" placeholder="Enter the amount here" name="sp">
						</div>
					</div>
