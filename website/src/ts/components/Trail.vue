	...
	<div class="container article">
		<div class="row">
			<div style="width: 100%; position: relative;">
				<h3 class="my-4">SteemMakers' trail</h3>
				<h4 class="my-4">Support by voting</h4>
				<p>One of the ways in which we aim to support DIYers and makers is by upvoting outstanding content that may otherwise go unnoticed. We do this because of several reasons:</p>

				<ul>
					<li>we believe some content just deserves a bigger reward</li>
					<li>users who put in a lot of time and effort and are neglected may become disheartened and give up - this is obviously a problem if we want to expand Steemit and attract/retain good writers</li>
					<li>support the Steem platform as a whole by focusing on good content</li>
				</ul>
